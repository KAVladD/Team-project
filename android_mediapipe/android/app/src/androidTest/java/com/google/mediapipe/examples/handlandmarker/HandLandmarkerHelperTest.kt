...
class HandLandmarkerHelperTest {
    ...
    fun landmarkerLiveStreamModeResultsFallsWithinAcceptedRange() {
        var landmarkerResult: HandLandmarkerHelper<Any?>.ResultBundle? = null
        val handLandmarkerHelper =
            HandLandmarkerHelper<Any>(
                context = ApplicationProvider.getApplicationContext(),
                runningMode = RunningMode.LIVE_STREAM,
                handLandmarkerHelperListener = object :
                    HandLandmarkerHelper<Any?>.LandmarkerListener {
                    ...
                    override fun onResults(
                        resultBundle: HandLandmarkerHelper<Any?>
                        .ResultBundle
                    ) {
    ...
    fun landmarkerVideoModeResultFallsWithinAcceptedRange() {
        val handLandmarkerHelper = HandLandmarkerHelper<Any>(
            context = ApplicationProvider.getApplicationContext(),
